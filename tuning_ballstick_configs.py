...
"""
Functions returning parameter dictionaries for the DSGC balance model in ball
stick mode, specifically for the subunit tuning schematic figure.
"""
...
def thesis(
    ...
    params = {
        ...
        "ballstick_mode": True,
        "sac_fixed_picker": sac_fixed_picker,
    }
    ...
    params["synprops"]["I"]["weight"] = base_w * 1.8 * 0.8
    params["synprops"]["NMDA"]["weight"] = base_w * 1.5 * 0.3
